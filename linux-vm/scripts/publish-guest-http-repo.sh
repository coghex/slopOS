...
GUEST_HELPER_SOURCE="$ROOT_DIR/board/rootfs-overlay/usr/sbin/slopos-publish-http-repo"
...
GUEST_HELPER_DEST="${GUEST_HELPER_DEST:-/tmp/slopos-publish-http-repo}"

"$ROOT_DIR/scripts/scp-to-guest.sh" "$GUEST_HELPER_SOURCE" "$GUEST_HELPER_DEST"
