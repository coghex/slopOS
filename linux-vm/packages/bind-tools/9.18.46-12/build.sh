...
install -Dm0755 "$PKG_BUILD_DIR/bin/dig/dig" "$PKG_DESTDIR/$PREFIX/bin/dig"
install -Dm0755 "$PKG_BUILD_DIR/bin/dig/host" "$PKG_DESTDIR/$PREFIX/bin/host"
install -Dm0755 "$PKG_BUILD_DIR/bin/dig/nslookup" "$PKG_DESTDIR/$PREFIX/bin/nslookup"
install -Dm0755 "$PKG_BUILD_DIR/bin/nsupdate/nsupdate" "$PKG_DESTDIR/$PREFIX/bin/nsupdate"
